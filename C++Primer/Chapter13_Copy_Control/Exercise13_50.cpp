/*
String 移动操作加打印，重跑练习 13.48 `vector<String>` push_back

/*
因为已经删去部分成员函数在c++17
PS D:\dev\workspace\C++Learning\C++Primer\Chapter13_Copy_Control> g++ Exercise13_50.cpp -o test -std=c++14 
PS D:\dev\workspace\C++Learning\C++Primer\Chapter13_Copy_Control> ./test
0
【移动构造函数】
1
【移动构造函数】
...
String::String(const char *c_str)
{
    ...
    end = elements + len + 1; // 抓住不变性end - elements = len + 1 (申请空间)
}
...
// 移动构造
String::String(String &&orig)noexcept
{
    cout << "【移动构造函数】" << endl;
